...
export default function ConfirmCard({ contactStatus, setContactStatus }: Props) {
  ...
  return (
    <div className={`w-full h-screen  ${contactStatus === "OK" ? "flex" : "hidden"} fixed top-0 flex items-center justify-center z-50 p-1 backdrop-blur-sm bg-[#ffffff1c]`}>
      <div className="max-w-[320px] flex space-y-6 rounded-2xl flex-col items-center w-full shadow-3xl p-8  bg-color5">
        ...
        <span className="font-sans text-center text-slate-300">Sua mensagem foi enviada com sucesso! Obrigado pelo contato.</span>
